...
import SuccessMessage from "../components/courier/SuccessMessage";
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        {delivery_modes.map((delivery_mode) => (
                          <option
                            key={delivery_mode.id}
                            value={delivery_mode.id}
                          >
                            {delivery_mode.title}
                          </option>
                        ))}
